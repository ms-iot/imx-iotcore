...
namespace {
  ...
  const IMX_PIN_DATA Imx6ULLGpioPinDataSparseMap[] = {
    ...
    { IMX_MAKE_PIN_1(1, 12), 0x2D8, 0x0000B0B1, 0x4C, 0x00 }, // GPIO1_IO12 JTAG_TDO
  ...
  const IMX_PIN_INPUT_DATA Imx6ULLGpioPinInputSelectTable[] = {
    ...
    { IMX_MAKE_PIN_1(1, 0), 2, 0x4B8, 0 }, // IOMUXC_SW_MUX_CTL_PAD_GPIO1_IO00 - ALT2 - ANATOP_OTG1_ID - IOMUXC_USB_OTG1_ID_SELECT_INPUT
    ...
    { IMX_MAKE_PIN_1(1, 21), 4, 0x590, 0 }, // IOMUXC_S- ALT4 - GPT1_CAPTURE2 - IOMUXC_GPT1_CAPTURE2_SELECT_INPUT
    ...
    { IMX_MAKE_PIN_1(1, 24), 8, 0x4B8, 1 }, // IOMUXC_SW_MUX_CTL_PAD_UART3_TX_DATA - ALT8 - ANATOP_OTG1_ID - IOMUXC_USB_OTG1_ID_SELECT_INPUT
    ...
    { IMX_MAKE_PIN_1(1, 30), 0, 0x644, 4 }, // IOMUXC_SW_MUX_CTL_PAD_UART5_TX_DATA - ALT0 - UART5_TX - IOMUXC_UART5_RX_DATA_SELECT_INPUT
    ...
    { IMX_MAKE_PIN_1(1, 31), 0, 0x644, 5 }, // IOMUXC_SW_MUX_CTL_PAD_UART5_RX_DATA - ALT0 - UART5_RX - IOMUXC_UART5_RX_DATA_SELECT_INPUT
    ...
    { IMX_MAKE_PIN_1(2, 2), 1, 0x640, 3 }, // IOMUXC_SW_MUX_CTL_PAD_ENET1_RX_EN - ALT1 - UART5_RTS_B - IOMUXC_UART5_RTS_B_SELECT_INPUT
    ...
    { IMX_MAKE_PIN_1(2, 3), 1, 0x640, 4 }, // IOMUXC_SW_MUX_CTL_PAD_ENET1_TX_DATA0 - ALT1 - UART5_CTS_B - IOMUXC_UART5_RTS_B_SELECT_INPUT
    ...
    { IMX_MAKE_PIN_1(2, 18), 8, 0x4B8, 2 }, // IOMUXC_SW_MUX_CTL_PAD_SD1_DATA0 - ALT8 - ANATOP_OTG1_ID - IOMUXC_USB_OTG1_ID_SELECT_INPUT
    ...
    { IMX_MAKE_PIN_1(4, 23), 8, 0x640, 5 }, // IOMUXC_SW_MUX_CTL_PAD_CSI_DATA02 - ALT8 - UART5_RTS_B - IOMUXC_UART5_RTS_B_SELECT_INPUT
