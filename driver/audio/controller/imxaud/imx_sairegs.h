...
//
// IM7DRM: 13.8.4.1 SAI Transmit Control Register (I2Sx_TCSR)
//
typedef union {
    ULONG AsUlong;
    struct {
...
//
// IM7DRM: 13.8.4.2 SAI Transmit Configuration 1 Register (I2Sx_TCR1)
//
typedef union {
    ULONG AsUlong;
    struct {
...
//
// IM7DRM: 13.8.4.3 SAI Transmit Configuration 2 Register (I2Sx_TCR2)
//
typedef union {
    ULONG AsUlong;
    struct {
...
//
// IM7DRM: 13.8.4.4 SAI Transmit Configuration 3 Register (I2Sx_TCR3)
//
typedef union {
    ULONG AsUlong;
    struct {
...
//
// IM7DRM: 13.8.4.5 SAI Transmit Configuration 4 Register (I2Sx_TCR4)
//
typedef union {
    ULONG AsUlong;
    struct {
...
//
// IM7DRM: 13.8.4.6 SAI Transmit Configuration 5 Register (I2Sx_TCR5)
//
typedef union {
    ULONG AsUlong;
    struct {
...
//
// IM7DRM: 13.8.4.7 SAI Transmit Data Register (I2Sx_TDRn)
//
typedef union {
    ULONG AsUlong;
    struct {
...
//
// IM7DRM: 13.8.4.8 SAI Transmit FIFO Register (I2Sx_TFRn)
//
typedef union {
    ULONG AsUlong;
    struct {
...
//
// IM7DRM: 13.8.4.9 SAI Transmit Mask Register (I2Sx_TMR)
//
typedef union {
    ULONG AsUlong;
    struct {
...
//
// IM7DRM: 13.8.4.10 SAI Receive Control Register (I2Sx_RCSR)
//
typedef union {
    ULONG AsUlong;
    struct {
...
//
// IM7DRM: 13.8.4.11 SAI Receive Configuration 1 Register (I2Sx_RCR1)
//
typedef union {
    ULONG AsUlong;
    struct {
...
//
// IM7DRM: 13.8.4.12 SAI Receive Configuration 2 Register (I2Sx_RCR2)
//
typedef union {
    ULONG AsUlong;
    struct {
...
//
// IM7DRM: 13.8.4.13 SAI Receive Configuration 3 Register (I2Sx_RCR3)
//
typedef union {
    ULONG AsUlong;
    struct {
...
//
// IM7DRM: 13.8.4.14 SAI Receive Configuration 4 Register (I2Sx_RCR4)
//
typedef union {
    ULONG AsUlong;
    struct {
...
//
// IM7DRM: 13.8.4.15 SAI Receive Configuration 5 Register (I2Sx_RCR5)
//
typedef union {
    ULONG AsUlong;
    struct {
...
//
// IM7DRM: 13.8.4.16 SAI Receive Data Register (I2Sx_RDRn)
//
typedef union {
    ULONG AsUlong;
    struct {
...
//
// IM7DRM: 13.8.4.17 SAI Receive FIFO Register (I2Sx_RFRn)
//
typedef union {
    ULONG AsUlong;
    struct {
...
//
// IM7DRM: 13.8.4.18 SAI Receive Mask Register (I2Sx_RMR)
//
typedef union {
    ULONG AsUlong;
    struct {
